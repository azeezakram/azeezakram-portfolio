...
const MobileMenu = ({menuClicked, setMenuClicked}) => {
  return (
    <>
      <div className={`absolute block lg:hidden top-0 right-0 left-0 p-6 bg-[#191b20] h-[100vh] z-51 ${menuClicked ? 'translate-y-0 overflow-y-scroll' : '-translate-y-1000'} duration-800 ease-in-out`}>
        ...
        <div className='h-full flex justify-center items-center flex-col font-medium text-lg'>
