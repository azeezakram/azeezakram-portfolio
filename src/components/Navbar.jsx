...
import siteLogoFull from '../assets/images/logo.png';
...
export default function Navbar() {
    ...
    return (
        <>
            <nav
                className={`absolute top-0 left-0 right-0 z-50 backdrop-blur-sm transition-all duration-800 ease-in-out ${scrolled ? 'bg-black/15' : ''}`}
                data-aos="fade-down" data-aos-duration="1000" data-aos-once="false" data-aos-mirror="true">
                <div
                    ...
                    <div className='flex justify-start text-3xl w-full'>
                        <a href='#hero' className='min-w-[95px]'>
                            ...
                            <img
                                src={scrolled ? siteLogoSlogan : siteLogoFull}
                                className={`m-1 hover:animate-pulse ${scrolled ? 'h-[24px]  xl:h-[28px]' : 'h-[30px]  xl:h-[22px]'}`}
                                id='logo'
                            />
                            {/* <p className='text-[1rem] font-[300] md:text-[1.1rem] text-gray-400 '>Azeez Akram.</p> */}
